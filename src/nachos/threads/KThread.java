...
public class KThread {
     ...
     * delete this thread.
     */
    public static void finish() {											//Consider changing to fix join()
	...
	if(currentThread.joinThread != null && currentThread.joinThread.status != 4){
     ...
     * thread.
     */
    public void join() {   		//current thread = joiner     a=currentthread        		this = joinee has called b.join()  b=this															 // This Method Needs to be completed
    	...
    	if(this.status != 4){
    		...
    		this.joinThread = KThread.currentThread;
